...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CA4RTRUHW2EFCUOMKC73NSVZITLKEBLGUP4V5BIPZMWOSMWBJLEIBANX";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        create: (json: string) => AssembledTransaction<Pet>;
        feed: (json: string) => AssembledTransaction<null>;
        play: (json: string) => AssembledTransaction<null>;
        sleep: (json: string) => AssembledTransaction<null>;
        work: (json: string) => AssembledTransaction<null>;
        mint_glasses: (json: string) => AssembledTransaction<null>;
        get_pet: (json: string) => AssembledTransaction<Pet>;
        get_coins: (json: string) => AssembledTransaction<bigint>;
    };
}
